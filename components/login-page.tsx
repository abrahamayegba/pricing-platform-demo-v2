      ...
      <div className="w-full max-w-sm -mt-10">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-white/60 text-xs mt-2">
            Virtual Services Group Pricing Platform
          </p>
        </div>
        ...
        <Card className="border-0 shadow-xl">
          <CardHeader className="pb-4">
            ...
            <CardDescription>
              Enter your credentials to access the pricing platform
            </CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <div className="mt-5 pt-4 border-t">
              ...
              <div className="flex flex-col gap-1.5">
                {[
                  {
                    email: "abraham@virtualfs.co.uk",
                    label: "Abraham Ayegba — Admin",
                  },
                  {
                    email: "grant@virtualfs.co.uk",
                    label: "Grant Currie — Admin",
                  },
                ].map((u) => (
                  <button
                    key={u.email}
